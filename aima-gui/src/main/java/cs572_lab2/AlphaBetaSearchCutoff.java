 ...
 */
public class AlphaBetaSearchCutoff<STATE, ACTION, PLAYER> implements
	...
	public static <STATE, ACTION, PLAYER> AlphaBetaSearchCutoff<STATE, ACTION, PLAYER> createFor(
			Game<STATE, ACTION, PLAYER> game) {
		return new AlphaBetaSearchCutoff<STATE, ACTION, PLAYER>(game);
	}

	public AlphaBetaSearchCutoff(Game<STATE, ACTION, PLAYER> game) {
		this.game = game;
	}
